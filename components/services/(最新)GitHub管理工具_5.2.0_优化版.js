    ...
    class GitHubUIManager {
        ...
        createFloatingButton() {
            ...
            document.addEventListener('mousemove', (e) => {
                ...
                fab.style.left = Math.min(window.innerWidth - size, Math.max(0, rect.left + (e.clientX - sx))) + 'px';
                fab.style.top  = Math.min(window.innerHeight - size, Math.max(0, rect.top  + (e.clientY - sy))) + 'px';
