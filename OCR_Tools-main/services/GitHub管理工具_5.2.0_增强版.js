            ...
            panel.innerHTML = `
                <div class="github-tools-header">
                    ...
                    <div class="header-actions">
                        <button class="action-btn settings-btn" title="设置" id="settings-btn-toggle">⚙️</button>
                ...
                <div class="github-tools-body">
                    ...
                    <div class="github-tools-section" id="config-section" style="display: none;">
                        ...
                        <div class="config-group">
                            <label class="config-label">切换面板快捷键</label>
                            <input type="text" class="config-input" id="hotkey-toggle" 
                                   placeholder="Alt+G">
                            <div class="config-hint">支持: Ctrl, Alt, Shift + 字母</div>
                        </div>
                        <div class="config-group">
                            <label class="config-label">删除文件快捷键</label>
                            <input type="text" class="config-input" id="hotkey-delete" 
                                   placeholder="Alt+D">
                        </div>
                        <div class="config-group">
                            <label class="config-label">上传文件快捷键</label>
                            <input type="text" class="config-input" id="hotkey-upload" 
                                   placeholder="Alt+U">
                        </div>
